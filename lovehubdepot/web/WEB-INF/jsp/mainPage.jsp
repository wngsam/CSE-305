                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="hidden">
                         ...
                         <li class="page-scroll">
                            <a href="viewperson=tellus.lorem.eu@atlacus.org">Person</a>
                        </li>
                        <li class="page-scroll">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-4 portfolio-item">
                        <p>Brenna_Berlin's profile</p>
                        <a href="viewprofile=Brenna_Berlin" class="portfolio-link" data-toggle="modal">
                            <div class="caption">
                                <div class="caption-content">
                                    <i class="fa fa-search-plus fa-3x">Brenna_Berlin's profile</i>
                                </div>
                            </div>
