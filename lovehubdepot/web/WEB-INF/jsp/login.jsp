...
<html lang="en">
    ...
    <body id="page-top" class="index">
                            ...
                            <form id="login" method="POST" action="login.html">
                                ...
                                <div class="row control-group">
                                    <div class="form-group col-xs-12 floating-label-form-group controls">
                                        ...
                                        <input id="pword" type="password" class="form-control" placeholder="Password" name="password" onfocus="wipeField(this)" onchange="hashField(this)">
                                        <p class="help-block text-danger"></p>
                                    </div>
                                </div>
                                ...
                                <a href="signup.html" class="btn btn-success btn-lg">Not a member? Register Now!</a> <br></br>
                            </form>
                        </div>
                    </div>
                </div>
        ...
        <script>
            function wipeField (passed)
            {
                passed.value = "";
            }
            function hashField (passed)
            {
                passed.value = hex_sha256(passed.value);
            }
        </script>
    </body>
