    ...
    <body id="page-top" class="index">
                ...
                <div class="row" align ="left">
                    ...
                    <div >
                        <c:if test="${disable==null}">
                            <button class="btn btn-danger" onClick="location.href = 'likeprofile=${currentProfile.profileID}=${currentPerson.SSN}'">Like</button>
                        </c:if>
                        <div class="col-lg-2">

                            <a href="profileinfo=${currentProfile.profileID}=${currentPerson.SSN}" class="btn btn-danger">Edit Profile</a>
        ...
        <div class="container" style="
            ...
            <div class="row" style="
                ...
                <table class="table-bordered" style="
                    ...
                    <c:forEach items="${dates}" var="date" varStatus="count">
                        <tr>
                            <td class="col-lg-2"><a  href="commentdate=${date.profile1}=${date.profile2}=${date.getDate_Time()}">${date.profile1}</a></td>
                            <td class="col-lg-2"><a  href="commentdate=${date.profile1}=${date.profile2}=${date.getDate_Time()}">${date.profile2}</a></td>
                            <td class="col-lg-2"><a  href="commentdate=${date.profile1}=${date.profile2}=${date.getDate_Time()}">${date.getCustRep()}</a></td>
                            <td class="col-lg-2"><a  href="commentdate=${date.profile1}=${date.profile2}=${date.getDate_Time()}">${date.getDate_Time()}</a></td>
                            <td class="col-lg-2"><a  href="commentdate=${date.profile1}=${date.profile2}=${date.getDate_Time()}">${date.getLocation()}</a></td>
                            <td class="col-lg-2"><a  href="commentdate=${date.profile1}=${date.profile2}=${date.getDate_Time()}">${date.getBookingFee()}</a></td>
                            <td class="col-lg-2"><a  href="commentdate=${date.profile1}=${date.profile2}=${date.getDate_Time()}">${date.getComments()}</a></td>
                            <td class="col-lg-3"><a  href="commentdate=${date.profile1}=${date.profile2}=${date.getDate_Time()}">${date.getUser1Rating()}</a></td>
                            <td class="col-lg-3"><a  href="commentdate=${date.profile1}=${date.profile2}=${date.getDate_Time()}">${date.getUser2Rating()}</a></td>
                        </tr>
                        <tr></tr>
                        <tr></tr>
                        <tr></tr>
                ...
                <table  style="     
                    ...
                    <c:forEach items="${likes}" var="like" varStatus="count">
                        <tr>
                            ...
                            <td class="col-lg-2">${like.likee}</td>
            ...
            <div class="row" style="
                 ...
                 margin-top:50px;
                 ">
                <h1 class="col-lg-offset-4">Suggestion List</h1>
                ...
                <table  style="     
                    ...
                    <tr style="
                        font-weight: bold;
                        font-size:24px;" >
                        <td class="col-lg-11">Profile</td>
                        <td class="col-lg-4">Age</td>

                        </font>
                    </tr>

                    <c:forEach items="${suggestlist}" var="suggestlist" varStatus="count">
                        <tr >
                            <td> <a   href="viewprofile=${suggestlist.profileID}">${suggestlist.profileID}</a></td>
                            <td> ${suggestlist.age}</td>
