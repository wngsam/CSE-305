                ...
                <div class="container " >
                    <div class="row">
                        <div class="col-lg-12 text-center">
                            <h2>Editing Date</h2>
                            <h2>${profile1} ${profile2} At ${datetime}</h2>
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-lg-offset-2">
                            ...
                            <form id="commentdate" method="POST" action="commentdate=${profile1}=${profile2}=${datetime}" novalidate>
                                ...
                                <div class="row">
                                    <div class="form-group col-xs-12">
                                        <button type="submit" class="btn btn-success btn-lg">Edit Comment</button>
                                    </div>
                                </div>
                            </form>
                        </div>
